...
const FilterFood = ({ navigation }) => {
    ...
    const FilterSubmit = () => {
        if (Date && FoodValue && Address && Info) {
    ...
    return (
        <SafeAreaView style={DEFAULTSTYLES.AndroidSafeArea}>
                ...
                <View>
                    ...
                    <View style={DEFAULTSTYLES.alignView}>
                        <View style={styles.viewCateg}>
                            <Text style={styles.inputCateg}>Food</Text>
                        </View>
                    </View> */}
                    ...
                    <View style={styles.cardView}>
                        <Text style={styles.textCatg}>Choose food</Text>
                    </View>
                    <View style={[DEFAULTSTYLES.alignView, { marginBottom: GlobalSize(15) }]}>
                        <Dropdown
                    ...
                    <View style={DEFAULTSTYLES.alignView}>
                        <View style={styles.viewCateg}>
                            <Text style={styles.textFood}>Breakfast - usually around 6 am to 9 am</Text>
                            <Text style={styles.textFood}>Lunch - usually around noon or 1 pm</Text>
                        </View>
                    </View>
                    ...
                    <View style={[DEFAULTSTYLES.alignView, { marginBottom: GlobalSize(20) }]}>
                        <TextInput
                            multiline
                            style={[styles.viewCateg, { height: GlobalSize(60), alignItems: 'flex-start', textAlignVertical: 'top' }]}
                            value={Info}
            ...
            <View style={styles.viewPost}>
                <TouchableOpacity
                    style={[styles.btnView, { opacity: Date && FoodValue && Info && Address ? 1 : 0.5 }]}
