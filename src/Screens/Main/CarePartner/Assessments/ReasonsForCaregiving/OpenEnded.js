...
const OpenEnded = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ backgroundColor: BACKGROUNDWHITE, flex: 1 }}>
      ...
      <KeyboardAvoidingView
        behavior='position' // You can use 'height' or 'position' as well
      //keyboardVerticalOffset={35} // Adjust this value as needed
      >
        <ScrollView showsVerticalScrollIndicator={false} style={{marginBottom:GlobalSize(80)}}>
