...
const SignUpForm = ({ navigation }) => {
  ...
  const handleCodeChange = (text) => {
    const isValidName = /^[ A-Za-z1234567890\s]{2,6}$/.test(text);
  ...
  const OnValidation = () => {
    if (Code == null) {
      ...
      navigation.navigate('CreatePasswordScreen')
      // RegisterUser(Name, Email, relationV,
      //   Code, PhoneNum, Address, zipcode, DOB, selectedOption, dispatch)
    }
  }
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={styles.inputTextViewStyle}>
            ...
            <TextInput
              ...
              style={[styles.textInputStyle, { borderColor: !CodeStatus ? VALIDCOLOR : BORDERCOLOR4 }]} />
          ...
          <View style={styles.inputTextViewStyle}>
            ...
            <View style={styles.inputTextViewStyle}>
              ...
              <TextInput
                ...
                style={[styles.textInputStyle, { borderColor: !AddStatus ? VALIDCOLOR : BORDERCOLOR4 }]} />
