...
//REDUX
import { verifyEmailReset } from '../../../redux/thunk';
        ...
        <SafeAreaView style={{ backgroundColor: BACKGROUNDWHITE, flex: 1 }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.container}>
                    ...
                    <View style={{ marginLeft: DEFAULTWIDTH * 0.06, alignItems: 'center' }}>
                        <Image source={require('../../../../assets/Images/NEWSIGNIN/Verify.png')}
                            style={{ width: width(420), height: height(350) }} resizeMode='contain' />
                    </View>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('SignIn')}>
                        <View style={[styles.viewSign, { bottom: GlobalSize(15) }]} >
            ...
            <ToolTipModal
                ...
                Desc={'It is required to verify your email or phone number which your account is registered with. '} />
        </SafeAreaView>
    )
};
