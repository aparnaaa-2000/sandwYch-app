...
import { BORDERCOLOR1, PUREBLACK, PUREWHITE, TEXTCOLOR11, TEXTCOLOR12 } from '../../../Constants/Colors/Colors';
import FastImage from 'react-native-fast-image';
import { DEFAULTWIDTH } from '../../../Constants/styles/styles';
import { GlobalSize, fontSize } from '../../../Constants/ResponsiveFont/ResponsiveFonts';

const ListItem = ({ messages, setMessages, navigation, Name }) => {
            ...
            return (
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.timeView}>
                  <Text style={styles.timeDis}>{moment(item?.timestamp).format('ddd')} {moment(item?.timestamp).format('h:mm')}</Text>
                </View>
                <View style={styles.viewEnd} >
                  ...
                  <View>
                    ...
                    {item.type == "text" ?
                      <View style={[styles.messageContainer, { maxWidth: DEFAULTWIDTH * 0.80 }]}>
