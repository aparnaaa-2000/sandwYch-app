import { StyleSheet, Text, View, SafeAreaView, StatusBar, Image, TextInput, ScrollView, TouchableOpacity } from 'react-native'
import React, { useState, useRef } from 'react'
import { BORDERCOLOR4, PRIMARYCOLOR, PUREWHITE, TEXTCOLOR10, TEXTCOLOR7, TEXTCOLORRS, VALIDCOLOR } from '../../../Constants/Colors/Colors'
import DEFAULTSTYLES, { DEFAULTHEIGHT, DEFAULTWIDTH } from '../../../Constants/styles/styles'
import { ArrowF, WhiteArrow, WhiteArrowL, WhiteCamera, WhiteLeftArrow } from '../../../../assets'
                ...
                <View style={styles.viewPureWhite}>
                    ...
                    <View>
                        ...
                        <TextInput
                            ref={NameRef}
                            value={FullName}
                            style={[styles.textIn, { borderColor: !NameStatus ? VALIDCOLOR : BORDERCOLOR4 }]}
                            onChangeText={(text) => handleNameChange(text)} />

                        {!NameStatus && (
                            <Text style={{ color: VALIDCOLOR, fontSize: fontSize(12) }}>Name is required</Text>
                        )}
                    ...
                    <View>
                        ...
                        <TextInput
                            ...
                            style={[styles.textIn, { borderColor: !EmailStatus ? VALIDCOLOR : BORDERCOLOR4 }]}
                            onChangeText={(text) => handleEmailChange(text)} />

                        {!EmailStatus && (
                            <Text style={{ color: VALIDCOLOR, fontSize: fontSize(12) }}>Email address is required</Text>
                        )}
                    </View>
                    ...
                    <View>
                        ...
                        <TextInput
                            ref={MobileRef}
                            value={PhoneNum}
                            style={[styles.textIn, { borderColor: !PhoneStatus ? VALIDCOLOR : BORDERCOLOR4 }]}
                            keyboardType={'number-pad'}
                            maxLength={12}
                            onChangeText={(text) => handlePhoneChange(text)} />

                        {!PhoneStatus && (
                            <Text style={{ color: VALIDCOLOR, fontSize: fontSize(12) }}>Phone number is required</Text>
                        )}
                    ...
                    <View>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={{ flexDirection: 'row',alignItems:'center'}}>
                                <TouchableOpacity
                                    ...
                                    <View style={[styles.radioIcon, Gender == 'Male' && styles.radioIconSelected]}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <TouchableOpacity
                                    ...
                                    <View style={[styles.radioIcon, Gender == 'Female' && styles.radioIconSelected]}>
                        ...
                        {!GenderStatus && (
                            <View>
                                <Text style={{ color: VALIDCOLOR, fontSize: fontSize(12) }}>Gender is required</Text>
                            </View>
                        )}
                    </View>
                    <View>
                        ...
                        <TextInput
                            ...
                            value={Address}
                            multiline
                            style={[styles.textIn, { borderColor: !AddStatus ? VALIDCOLOR : BORDERCOLOR4 ,
                                height:GlobalSize(100),textAlignVertical:'top'}]}
                            onChangeText={(text) => handleAddressChange(text)} />

                        {!AddStatus && (
                            <Text style={{ color: VALIDCOLOR, fontSize: fontSize(12) }}>Address is required</Text>
                        )}
