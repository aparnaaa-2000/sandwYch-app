  ...
  return (
    <SafeAreaView style={DEFAULTSTYLES.AndroidSafeArea}>
      ...
      showsVerticalScrollIndicator={false}
       style={{ marginBottom: GlobalSize(100) }}>
        ...
        <View style={styles.medicineContainer}>
          ...
          <View style={styles.medicineIconContainer}>
            ...
            <View style={{ marginLeft: DEFAULTWIDTH * 0.02 }}>
              <Text style={styles.medicineName}>{DUMMYDATA.nameofMed}</Text>
              <View style={{ flexDirection: 'row' }}>
                <Text style={styles.diagnosisText}>Diagnosis: </Text>
                <Text style={styles.diagnosisName}>{DUMMYDATA.diagnosis}</Text>
              </View>
            </View>
          </View>
          <View style={styles.medicineMoreInfo}>
            <View style={styles.medicinePharmacistView}>
              ...
              <Text style={styles.pharmacistName}>{DUMMYDATA.physician}</Text>
            </View>
            <Text style={styles.hospitalName}>{DUMMYDATA.location}</Text>
          </View>
        </View>
            ...
            <View style={styles.dosageInfoRows}>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={styles.infoDescText}>
                  {DUMMYDATA.dosageInfo.lastTaken}
                </Text>
              </View>
            </View>
            <View style={styles.dosageInfoRows}>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={styles.infoDescText}>
                  {DUMMYDATA.dosageInfo.startDate}
                </Text>
              </View>
            </View>
            <View style={styles.dosageInfoRows}>
        ...
        <View style={styles.d2dInteactionContainer}>
          ...
          <View>
            {DUMMYDATA.d2dInteraction.Effects != 'null' ? (
              <View>
                <View style={{ marginHorizontal: DEFAULTWIDTH * 0.02 }}>
                  <View style={styles.medicationRow}>
                    ...
                    <Text style={styles.d2dAllergyText}>
                      {DUMMYDATA.d2dInteraction.medication1}
                    </Text>
                  </View>
                  ...
                  <View style={styles.medicationRow}>
                    ...
                    <Text style={styles.d2dAllergyText}>
                      {DUMMYDATA.d2dInteraction.medication2}
                    </Text>
                  </View>
                  ...
                  {DUMMYDATA.d2dInteraction.Effects.map((item, index) => (
                    <View style={styles.allergyRow}>
                      <Text key={index} style={styles.d2dAllergyText}>
                        {item.allergy}
                      </Text>
                      <View style={styles.allergyRiskBadge}>
                        <Text
                          key={index}
                          style={[
                            styles.hospitalName,
              ...
              <TouchableOpacity style={styles.btnPrimaryd2d}>
