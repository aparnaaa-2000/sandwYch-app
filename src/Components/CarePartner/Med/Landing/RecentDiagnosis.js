        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View>
            <View style={{ flexDirection: 'column' }}>
              <Text style={styles.diagnosisText}>Alzhimer</Text>
              <Text style={styles.icdText}>ICD Code: G30.9</Text>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
              ...
              <View style={[DEFAULTSTYLES.dateView, { marginRight: GlobalSize(30) }]}>
                <Text style={DEFAULTSTYLES.dateText}>05/01/2024</Text>
              </View>

              <View style={DEFAULTSTYLES.dateView}>
                <Text style={DEFAULTSTYLES.dateText}>For 1 Month</Text>
              </View>
            </View>
          </View>
