...
import { BORDERCOLOR4, PRIMARYCOLOR, PUREBLACK, PUREWHITE, VALIDCOLOR } from '../../../Constants/Colors/Colors';
            ...
            <View style={styles.mainContainer} >
                <View style={styles.viewMain}>
                    ...
                    <View style={DEFAULTSTYLES.alignView}>
                        <View style={[styles.borderView, { borderColor: errorStatus ? BORDERCOLOR4 : VALIDCOLOR }]}>
                            <TextInput
                                ref={reasonRef}
                                multiline
                    ...
                    {!errorStatus &&
                        <View style={{ marginLeft: DEFAULTWIDTH * 0.05 }}>
                            <Text style={{ color: VALIDCOLOR }}>Please enter your reason here</Text>
                        </View>}

                    <View style={[DEFAULTSTYLES.alignView, { marginTop: GlobalSize(15) }]}>
                        <TouchableOpacity style={[styles.touchBtn, { opacity: Reason ? 1 : 0.5 }]}
                            onPress={() => CloseModal()}>
