...
import { BACKGROUNDWHITE, BORDERCOLORW, PRIMARYCOLOR, PUREBLACK, PUREWHITE, TEXTCOLORW, SECONDARYCOLOR, BORDERCOLOR1, TEXTCOLOR10 } from '../../../Constants/Colors/Colors'
    ...
    return (
        ...
        <>
            <View style={styles.viewWeight}>
                ...
                {/* <View>
                    <Text style={styles.textInput}>{Unit}</Text>
                </View> */}
            </View>
                    ...
                    return (
                        <View key={item.id}
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <View>
                                    <Text style={styles.textWt}>{item.weight}</Text>
                                </View>
                            </View>

                            <View>
                                <Text style={styles.textWt}>{item.CreatedAt}</Text>
                            </View>
                        </View>
                    )
                })}
